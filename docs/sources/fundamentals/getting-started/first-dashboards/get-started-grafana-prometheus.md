...
source_url: https://github.com/grafana/grafana/blob/release-12.4.3/docs/sources/fundamentals/getting-started/first-dashboards/get-started-grafana-prometheus.md
